...
public class User {
	...
	public String toString() {
		return "User [id=" + id + ", sn=" + sn + ", cnName=" + cnName + ", type=" + type + ", name=" + name
				+ ", password=" + password + ", hintPwd=" + hintPwd + ", phone=" + phone + ", address=" + address
				+ ", classId=" + classId + ", status=" + status + ", permis=" + permis + ", head=" + head
